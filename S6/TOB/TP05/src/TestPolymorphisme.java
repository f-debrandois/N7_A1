...
public class TestPolymorphisme {
	...
	public static void main(String[] args) {
		...
		// Attacher un point à q et l'afficher
		// qn = p1;			// Est-ce autorisé ? Pourquoi ? Non
		...
		qn = pn1;			// Est-ce autorisé ? Pourquoi ? Oui. Meme type
