...
package Cache_LFU is
    ...
    -- Exception : Adresse_Absente_Exception si Destination n'est pas utilisée dans la Cache
    ...
    -- Appliquer un traitement (Traiter) pour les elements d'une Cachele.
    generic
